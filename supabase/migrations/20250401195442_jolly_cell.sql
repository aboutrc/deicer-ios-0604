/*
  # Create Map2 tables and schema
  
  1. Tables
    - map2_markers: Stores marker locations and metadata
    - map2_marker_confirmations: Tracks marker confirmations
...
DROP TABLE IF EXISTS map2_marker_confirmations;
DROP TABLE IF EXISTS map2_markers;
