...
-- Create pin-markers bucket if it doesn't exist
...
CREATE POLICY "Enable public read access for pin marker images"
ON storage.objects FOR SELECT
TO public
USING (bucket_id = 'pin-markers');

-- Enable public uploads with restrictions
CREATE POLICY "Enable image uploads for pin marker images"
