/*
  # Update rights sections with translated content
  
  1. Changes
    - Update content array to include translations for each language
    - Preserve existing table structure and data
    - Add proper translations for all sections
*/

-- First clear existing content
TRUNCATE TABLE rights_sections;

-- Insert new content with translations for each language
