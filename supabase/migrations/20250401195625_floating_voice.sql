/*
  # Fix Map2 tables and add profiles table
  
  1. Changes
    - Create profiles table first since it's referenced by foreign keys
...
DROP POLICY IF EXISTS "Anyone can view active markers" ON map2_markers;
DROP POLICY IF EXISTS "Anyone can insert markers" ON map2_markers;
DROP POLICY IF EXISTS "Users can update own markers" ON map2_markers;
DROP POLICY IF EXISTS "Anyone can view confirmations" ON map2_marker_confirmations;
DROP POLICY IF EXISTS "Anyone can insert confirmations" ON map2_marker_confirmations;
...
DROP INDEX IF EXISTS idx_map2_markers_active;
DROP INDEX IF EXISTS idx_map2_markers_coordinates;
DROP INDEX IF EXISTS idx_map2_markers_category;
DROP INDEX IF EXISTS idx_map2_markers_created_at;
DROP INDEX IF EXISTS idx_map2_markers_last_confirmed;
DROP INDEX IF EXISTS idx_map2_markers_reliability;
DROP INDEX IF EXISTS idx_map2_markers_user_id;
DROP INDEX IF EXISTS idx_map2_marker_confirmations_marker_id;
DROP INDEX IF EXISTS idx_map2_marker_confirmations_confirmed_at;
DROP INDEX IF EXISTS idx_map2_marker_confirmations_user_id;
...
DROP FUNCTION IF EXISTS update_map2_updated_at_column();
DROP FUNCTION IF EXISTS calculate_map2_marker_reliability();
