/*
  ...
  1. Changes
    - Update rights_sections content structure to ensure proper format for all languages
    - Fix blog_posts content structure for multilingual support
...
-- Insert new content with proper multilingual structure
...
-- Insert sample blog post with proper multilingual content
