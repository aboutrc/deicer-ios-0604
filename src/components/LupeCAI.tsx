...
import { AlertTriangle, Send, Mic, MicOff, MicOff as MicMute, Loader2, MessageSquare, Volume2, ArrowDown } from 'lucide-react';

interface LupeCAIProps {
  language?: 'en' | 'es' | 'zh' | 'hi' | 'ar';
}

const LupeCAI: React.FC<LupeCAIProps> = ({ language = 'en' }) => {
  ...
  return (
    <div className="bg-gray-900 flex justify-center p-0 overflow-y-auto mt-8 pt-4">
      <div className="max-w-md w-full flex flex-col gap-2">
        {/* Introduction text */}
        <div className="text-gray-300 text-sm mt-0">
          <p>
            {language === 'hi' ? (
        ...
        <div className="bg-black/40 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg border border-gray-700 flex flex-col mb-1">
          {error && (
          ...
          <div className="relative w-full h-[220px] overflow-hidden">
            ...
            {/* Conversation Control Buttons positioned at bottom of image */}
          ...
          <div 
            ...
            className="h-36 overflow-y-auto p-4 space-y-4 bg-gray-900/50"
          ...
          {showScrollButton && (
            <button
              ...
              className="absolute bottom-[90px] right-4 p-2 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-colors"
            >
              <ArrowDown size={20} />
            </button>
          )}
          ...
          <div className="p-4 border-t border-gray-700 bg-gray-800">
            ...
            {transcript && transcript.text && (
              <div className="mt-2 px-3 py-2 bg-gray-700/50 rounded text-gray-200 text-sm">
                <div className="flex items-center gap-2">
        ...
        <div className="text-gray-300 space-y-1 mb-8">
          <ul className="list-disc pl-6 space-y-1 text-xs mb-2">
            {[
